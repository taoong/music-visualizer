...
const CONFIG_TO_SLIDER: Record<keyof Config, string> = {
  ...
  kaleidoSegments: 'kaleido-segments',
  kaleidoTrail: 'kaleido-trail',
  kaleidoSmear: 'kaleido-smear',
  ...
  latticeGrid: 'lattice-grid',
  latticeWarp: 'lattice-warp',
  latticeGlow: 'lattice-glow',
};
