...
| `E` | Waterfall | Scrolling spectrogram: each frame's spectrum is painted on the right edge and shifts left over time, so peaks and troughs trail across the screen |
