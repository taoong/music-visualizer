...
| `a` | Aurora | 7 vertical aurora borealis light curtains span the full canvas height; each curtain is driven by a frequency band (sub-bass at far-left, brilliance at far-right); Perlin noise sways curtains laterally and wrinkles their edges creating organic flow; a vertical gradient produces the aurora "crown" — brilliant near the top fading to void at the bottom; screen-blend compositing lets overlapping curtains accumulate brightness naturally, just as real emission bands coincide in the sky; faint star field in the background dims during beat flashes; beats fire a whole-sky surge of luminosity; inspired by Helen Frankenthaler's Color Field painting "Mountains and Sea" (1952) — translucent stained washes of color that breathe on raw canvas — and Maotik "IRIDESCENT" (2018), a real-time data-driven light environment with flowing luminous ribbons — https://maotik.com/iridescent |
...
| `d` | Data Dream | A luminous field of thousands of audio-reactive data points drifts through a Perlin flow field like volumetric fog, each tinted by one of 7 frequency bands across a cool data-blue → indigo → violet → magenta → warm gold palette; on every beat the field "dreams" — points are pulled into a freshly generated organic polar-curve silhouette, glow as a coherent "data sculpture", then dissolve back into drifting fog as the form decays; offscreen ADD-blend buffer accumulates a soft trailing glow; inspired by Refik Anadol Studio's "Machine Hallucinations" practice and Dataland, the world's first AI-art museum (opening June 20, 2026, Los Angeles) and its inaugural exhibition "Machine Dreams: Rainforest" — https://refikanadol.com/ — sliders: Density (data-point count, sparse mist → dense fog), Flow (flow-field speed and turbulence), Form (strength and persistence of the beat-triggered dream formation) |
