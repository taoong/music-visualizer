...
│   ├── pendulumwave.ts        # Pendulum Wave: 21 pendulums (15 mobile) with incrementally different frequencies; audio-driven swing amplitude; beat energy injection; trails create wave envelope; HSB blue→red by freq band
...
│   └── keyboard.ts            # Keyboard shortcuts (0-9 viz modes, n/p/g/w/c/b/u/y letter shortcuts, space, arrows, m/f/s/r/i/?/h/Esc)
├── types/
