...
│   ├── kaleidoscope.ts        # Kaleidoscope: 7 frequency bands drive concentric arcs and radial spokes within a wedge that is rotated and mirror-flipped N times to fill the screen; multi-pass glow on each arc; Perlin noise modulates arc radii; beats shift hue palette and trigger zoom pulses; sliders: Segments (symmetry 3–16), Zoom, Speed
